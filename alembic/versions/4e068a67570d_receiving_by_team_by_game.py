...
Revision ID: 4e068a67570d
Revises: 8f42b1be94e5
Create Date: 2021-02-21 16:58:25.718983
...
revision = '4e068a67570d'
down_revision = '8f42b1be94e5'
branch_labels = None
depends_on = None
...
def upgrade():
    op.execute("""
        DROP TABLE IF EXISTS receiving_by_team_by_game;
        CREATE TABLE passing_by_team_by_game (
...
def downgrade():
    op.execute("""DROP TABLE IF EXISTS passing_by_team_by_game;""")
