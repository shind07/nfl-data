...
Revision ID: 8f42b1be94e5
Revises: db2c1ff68735
Create Date: 2021-02-21 02:41:08.503237
...
revision = '8f42b1be94e5'
down_revision = 'db2c1ff68735'
branch_labels = None
depends_on = None
...
def downgrade():
    op.execute("""DROP TABLE IF EXISTS passing_by_player_by_year;""")
