...
Revision ID: c6b1a6d2485a
Revises: 55cb8674548b
Create Date: 2021-02-21 23:09:38.219838
...
revision = 'c6b1a6d2485a'
down_revision = '55cb8674548b'
branch_labels = None
depends_on = None
...
def downgrade():
    op.execute("""DROP TABLE IF EXISTS play_by_play""")
