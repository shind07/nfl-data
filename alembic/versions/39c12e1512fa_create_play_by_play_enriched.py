"""create play by play enriched

Revision ID: 39c12e1512fa
Revises: 73dea82a55a9
Create Date: 2021-01-08 12:19:35.003002
...
revision = '39c12e1512fa'
down_revision = '73dea82a55a9'
branch_labels = None
depends_on = None
...
def upgrade():
    op.execute("""
        CREATE TABLE play_by_play_enriched (
            ...
            lateral_sack_player_id BOOLEAN,
            lateral_sack_player_name BOOLEAN,
            ...
            tackle_for_loss_2_player_id BOOLEAN,
            tackle_for_loss_2_player_name BOOLEAN,
            ...
            assist_tackle_3_player_id BOOLEAN,
            assist_tackle_3_player_name BOOLEAN,
            assist_tackle_3_team BOOLEAN,
            assist_tackle_4_player_id BOOLEAN,
            assist_tackle_4_player_name BOOLEAN,
            assist_tackle_4_team BOOLEAN,
            ...
            series_success BOOLEAN NOT NULL,
            ...
            play_deleted BOOLEAN NOT NULL,
            play_type_nfl VARCHAR,
            special_teams_play BOOLEAN NOT NULL,
            st_play_type VARCHAR,
            end_clock_time INTERVAL,
            end_yard_line VARCHAR,
            fixed_drive DECIMAL NOT NULL,
            fixed_drive_result VARCHAR,
            drive_real_start_time BOOLEAN,
            drive_play_count DECIMAL,
            drive_time_of_possession INTERVAL,
            ...
            drive_game_clock_start INTERVAL,
            drive_game_clock_end INTERVAL,
