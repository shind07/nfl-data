"""
Upstream jobs: receiving_by_player_by_year
...
OUTPUT_TABLE_NAME = "receiving_by_team_by_year"
...
def _extract_all(db_conn) -> pd.DataFrame:
    """Getting passing stats, per team per year for all positions"""
